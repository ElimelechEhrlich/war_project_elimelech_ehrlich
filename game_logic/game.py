...
def play_round(player_1: dict, player_2: dict):
    ...
    while (len(hend_of_player1) > 0) and (len(hend_of_player2) > 0):
        if  Compared == 'p1':
            print ('P1 Winner!!!')
            won_pile_of_player1.append(hend_of_player1.pop(hend_of_player1[-1])
            won_pile_of_player1.append(hend_of_player2.pop(hend_of_player2[-1]))
        elif  Compared == 'p2':
            print ('P2 Winner!!!')
            won_pile_of_player2.append(hend_of_player2.pop(hend_of_player2[-1]))
            won_pile_of_player2.append(hend_of_player1.pop(hend_of_player1[-1]))
        else:
            pass
